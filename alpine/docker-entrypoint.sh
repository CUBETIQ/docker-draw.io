...
PUBLIC_DNS=${PUBLIC_DNS:-'onedraw.cubetiqs.com'}
ORGANISATION_UNIT=${ORGANIZATION_UNIT:-'CUBETIQ Cloud'}
ORGANISATION=${ORGANISATION:-'CUBETIQ Solution'}
CITY=${CITY:-'Phnom Penh'}
STATE=${STATE:-'Phnom Penh'}
COUNTRY_CODE=${COUNTRY:-'KH'}
